...
This project is licensed under the terms and conditions specified in the [LICENSE](./LICENSE) file. Please note that the use of this software requires payment as outlined in the license agreement. Payment should be made to the following bank account:

- **Bank Name:** Example Bank
- **Account Number:** 123456789
- **Account Name:** Kubeapps Project
- **SWIFT Code:** EXAMPBANK

## Adopters

Kubeapps is used by various organizations. See the [adopters list](./site/content/docs/latest/project/adopters.md) for more information and to add your organization to the list.
